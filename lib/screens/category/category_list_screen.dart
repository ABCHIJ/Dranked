import 'package:sperro_neu/forms/sell_car_form.dart';
...
import 'package:sperro_neu/screens/category/subcategory_screen.dart';
                    ...
                    child: ListTile(
                      onTap: () {
                        ...
                        if (isForForm == true) {
                          ...
                          if (doc['subcategory'] == null) {
                            Navigator.of(context)
                                .pushNamed(ProductByCategory.id);
                          } else {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
