...
import 'package:sperro_neu/screens/auth/email_verify_screen.dart';
import 'package:sperro_neu/screens/auth/phone_otp_screen.dart';
    ...
    try {
      ...
      return users.doc(credential.user!.uid).set({
        ...
        await credential.user!.sendEmailVerification().then((value) {
          Navigator.pushReplacementNamed(context, EmailVerifyScreen.id);
        });
