...
import 'package:sperro_neu/constants/validators.dart';
...
class UserFormReview extends StatefulWidget {
  static const String id = 'user_form_review_screen';
...
class _UserFormReviewState extends State<UserFormReview> {
  ...
  Future<void> updateUserProductData(CategoryProvider categoryProvider,
  ...
  Future<void> saveProductToDatabase(
      CategoryProvider categoryProvider, BuildContext context) {
