...
import 'package:sperro_neu/screens/category/category_widget.dart';
import 'package:sperro_neu/components/main_appbar_with_search.dart';
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder:
        ...
        if (snapshot.hasData && !snapshot.data!.exists) {
          return customSnackBar(
              context: context, content: "Address not selected");
        }
