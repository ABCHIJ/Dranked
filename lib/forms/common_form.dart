...
import 'package:sperro_neu/components/image_picker_widget.dart';
...
import 'package:sperro_neu/forms/user_form_review.dart';
...
class CommonForm extends StatefulWidget {
  static const String id = 'common_form';
        ...
        onPressed: () async {
          if (_formKey.currentState!.validate()) {
            ...
            if (categoryProvider.imageUploadedUrls.isNotEmpty) {
              Navigator.pushNamed(context, UserFormReview.id);
            } else {
              customSnackBar(
                  context: context,
